# Psyflow - AI Mental Health Companion
...
- 🤖 Personalized wellness recommendations (exercises, meditation, activities)
- 🔒 Privacy-first design (encrypted data, no judgment)
- 💬 Conversational AI companion for emotional support
- 📈 Mental health insights & trend detection
...
- **Database:** Firebase
- **AI/ML:** Python (sentiment analysis, mood prediction, NLP)
- **Authentication:** JWT
- **Security:** Encryption, privacy-first architecture

## 🚀 Getting Started
[Installation instructions...]

## 👥 Team
- **Full-Stack Developer:** Benonia Ayeh
- **Data Scientist:** Sutharshan Suthakaran
